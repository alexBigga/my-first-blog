...
class Post(models.Model):
    ...
    # hier wird das Datum der Veröffentlichung gesetzt und gespeichert
    #
    # beide Methoden eingerückt => Gehören zur Klasse, können
    ...
    # Gibt den Titel (string) des neuen Beitrags zurück
    def __str__(self):
        return self.title
